...
public class Main {
	...
	public void show() {
		...
		System.out.println("--x+5=10-3 :" + "--x+5=10-3".matches("(([\\p{Punct}&&[-+]]?)(([\\p{Digit}]*)([\\p{Lower}&&[x]])|([\\p{Lower}&&[x]])([\\p{Digit}]*)|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])(([\\p{Digit}]*)([\\p{Lower}&&[x]])|([\\p{Lower}&&[x]])([\\p{Digit}]*)|[\\p{Digit}]+)){1,}=(([\\p{Punct}&&[-+]]?)(([\\p{Digit}]*)([\\p{Lower}&&[x]])|([\\p{Lower}&&[x]])([\\p{Digit}]*)|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])(([\\p{Digit}]*)([\\p{Lower}&&[x]])|([\\p{Lower}&&[x]])([\\p{Digit}]*)|[\\p{Digit}]+)){1,}"));
		System.out.println("-x4+5=10-3 :" + "-x4+5=10-3".matches("(([\\p{Punct}&&[-+]]?)(([\\p{Digit}]*)([\\p{Lower}&&[x]])|([\\p{Lower}&&[x]])([\\p{Digit}]*)|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])(([\\p{Digit}]*)([\\p{Lower}&&[x]])|([\\p{Lower}&&[x]])([\\p{Digit}]*)|[\\p{Digit}]+)){1,}=(([\\p{Punct}&&[-+]]?)(([\\p{Digit}]*)([\\p{Lower}&&[x]])|([\\p{Lower}&&[x]])([\\p{Digit}]*)|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])(([\\p{Digit}]*)([\\p{Lower}&&[x]])|([\\p{Lower}&&[x]])([\\p{Digit}]*)|[\\p{Digit}]+)){1,}"));
		System.out.println("-4++x=10-3 :" + "-4++x=10-3".matches("(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1,}=(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1,}"));
		...
		System.out.println("-4+xx=10-3 :" + "-4+xx=10-3".matches("(([\\p{Punct}&&[-+]]?)([\\p{Alnum}&&[x\\d]])){1}(([\\p{Punct}&&[-+]])([\\p{Alnum}&&[x\\d]])){1,}=(([\\p{Punct}&&[-+]]?)([\\p{Alnum}&&[x\\d]])){1}(([\\p{Punct}&&[-+]])([\\p{Alnum}&&[x\\d]])){1,}"));
		System.out.println("-x+5==10-3 :" + "-x+5==10-3".matches("(([\\p{Punct}&&[-+]]?)([\\p{Alnum}&&[x\\d]])){1}(([\\p{Punct}&&[-+]])([\\p{Alnum}&&[x\\d]])){1,}=(([\\p{Punct}&&[-+]]?)([\\p{Alnum}&&[x\\d]])){1}(([\\p{Punct}&&[-+]])([\\p{Alnum}&&[x\\d]])){1,}"));
		System.out.println("-4+x=10-3 :" + "-4+x=10-3".matches("(([\\p{Punct}&&[-+]]?)([\\p{Alnum}&&[x\\d]])){1}(([\\p{Punct}&&[-+]])([\\p{Alnum}&&[x\\d]]))*=(([\\p{Punct}&&[-+]]?)([\\p{Alnum}&&[x\\d]])){1}(([\\p{Punct}&&[-+]])([\\p{Alnum}&&[x\\d]]))*"));
		
		System.out.println("");
		System.out.println("-4+x=10-3 :" + "-4+x=10-3".matches("(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*=(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*"));
		System.out.println("-4x+x=10-3 :" + "-4x+x=10-3".matches("(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*=(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*"));
		System.out.println("-x4+x=10-3 :" + "-x4+x=10-3".matches("(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*=(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*"));
		System.out.println("-4+xx=10-3 :" + "-4+xx=10-3".matches("(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*=(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*"));

		System.out.println("");
		System.out.println("-4+x=10-3 :" + "-4+x=10-3".matches("(([\\p{Punct}&&[-+]]?)([\\p{Digit}]+)|(([\\p{Digit}]*[\\p{Lower}&&[x]])|([\\p{Lower}&&[x]][\\p{Digit}]*))){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*=(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*"));
		System.out.println("-4+x=10-3 :" + "-4+x=10-3".matches("(([\\p{Punct}&&[-+]]?)([\\p{Digit}]+|(([\\p{Digit}]*[\\p{Lower}&&[x]])|([\\p{Lower}&&[x]][\\p{Digit}]*)))){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*=(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*"));
		System.out.println("-4x+x4=10x-x3 :" + "-4x+x4=10x-x3".matches("(([\\p{Punct}&&[-+]]?)([\\p{Digit}]+|(([\\p{Digit}]*[\\p{Lower}&&[x]])|([\\p{Lower}&&[x]][\\p{Digit}]*)))){1}(([\\p{Punct}&&[-+]])([\\p{Digit}]+|(([\\p{Digit}]*[\\p{Lower}&&[x]])|([\\p{Lower}&&[x]][\\p{Digit}]*))))*=(([\\p{Punct}&&[-+]]?)([\\p{Digit}]+|(([\\p{Digit}]*[\\p{Lower}&&[x]])|([\\p{Lower}&&[x]][\\p{Digit}]*)))){1}(([\\p{Punct}&&[-+]])([\\p{Digit}]+|(([\\p{Digit}]*[\\p{Lower}&&[x]])|([\\p{Lower}&&[x]][\\p{Digit}]*))))*"));
		System.out.println("-4x+x4-xx=10x-x3+xx :" + "-4x+x4-xx=10x-x3+xx".matches("(([\\p{Punct}&&[-+]]?)([\\p{Digit}]+|(([\\p{Digit}]*[\\p{Lower}&&[x]])|([\\p{Lower}&&[x]][\\p{Digit}]*)))){1}(([\\p{Punct}&&[-+]])([\\p{Digit}]+|(([\\p{Digit}]*[\\p{Lower}&&[x]])|([\\p{Lower}&&[x]][\\p{Digit}]*))))*=(([\\p{Punct}&&[-+]]?)([\\p{Digit}]+|(([\\p{Digit}]*[\\p{Lower}&&[x]])|([\\p{Lower}&&[x]][\\p{Digit}]*)))){1}(([\\p{Punct}&&[-+]])([\\p{Digit}]+|(([\\p{Digit}]*[\\p{Lower}&&[x]])|([\\p{Lower}&&[x]][\\p{Digit}]*))))*"));
		System.out.println("-4x+x=10-3 :" + "-4x+x=10-3".matches("(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*=(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*"));
		System.out.println("-x4+x=10-3 :" + "-x4+x=10-3".matches("(([\\p{Punct}&&[-+]]?)([\\p{Digit}]+|(([\\p{Digit}]*[\\p{Lower}&&[x]])|([\\p{Lower}&&[x]][\\p{Digit}]*)))){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*=(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*"));
		System.out.println("-x4+x=10-3 :" + "-x4+x=10-3".matches("(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*=(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*"));
		System.out.println("-4+xx=10-3 :" + "-4+xx=10-3".matches("(([\\p{Punct}&&[-+]]?)([\\p{Digit}]+|(([\\p{Digit}]*[\\p{Lower}&&[x]])|([\\p{Lower}&&[x]][\\p{Digit}]*)))){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*=(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*"));
		System.out.println("-4+xx=10-3 :" + "-4+xx=10-3".matches("(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*=(([\\p{Punct}&&[-+]]?)([\\p{Lower}&&[x]]|[\\p{Digit}]+)){1}(([\\p{Punct}&&[-+]])([\\p{Lower}&&[x]]|[\\p{Digit}]+))*"));
